 ...
 *
 * A card view is a grid of cards that displays a small to moderate amount of content. The card view uses a [display] function to render the items in the [ItemsStore] as [Card]s.
 *
...
public class CardView<T> internal constructor(
    ...
    /**
     * Defines how to display the items in the [ItemsStore] as [Card]s.
     */
